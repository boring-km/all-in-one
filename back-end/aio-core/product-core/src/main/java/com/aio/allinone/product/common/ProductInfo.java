...
public class ProductInfo {
    ...
    @Override
    public int hashCode() {
        int result = Objects.hash(sellerId, title, address, pricePolicy, statusType, detail, createdAt, createdBy, updatedAt, updatedBy);
        result = 31 * result + Arrays.hashCode(rentalPeriod);
        result = 31 * result + Arrays.hashCode(pictureURLArray);
        return result;
    }
}
